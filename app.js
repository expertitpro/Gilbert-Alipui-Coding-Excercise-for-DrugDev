/*
* Gilbert Alipui
* TrialNetworks DrugDev Code Excercise.
                    ...
                    items: [
                        {
                            ...
                            bodyPadding: 20,
                            title: 'Gilbert Alipui: TrialNetworks DrugDev Code Excercise',
                            items: [
                                {
                                    ...
                                    items: [{
                                           ...
                                           xtype: 'numberfield',
                                            ...
                                            id: 'shift',
                                            padding: '2',
                                            emptyText: 'Enter an integer between 1 and 9'
                                    }]
                            }],
										...
										handler: function () {  // anonymous function handles the form submission after verifying that all required fields are valid
											...
											Ext.Ajax.request({
												...
												success: function(response){  // on success, display search results
                                                    ...
                                                    var title = 'Caesar Cipher Encryption Results.  Please click O.K. When done';
